...
const HeroSection = () => {
  return (
    <section className="flex flex-col items-center justify-start w-full h-auto gap-5 text-center text-gray-900 md:gap-4 dark:text-white paddingY bg-primary-bg-light dark:bg-primary-bg-dark paddingX md:!px-0">
      {/* Heading */}
      ...
      {/* Buttons */}
      <div className="flex flex-row justify-start items-center w-full md:h-[13%] h-[20%] gap-6 mt-10 md:flex-row md:justify-start">
        {/* Search Section */}
        <form className="flex flex-col items-start justify-center w-full md:h-full h-[9rem] gap-4 px-3 md:gap-6 md:flex-row md:items-center md:paddingX">
